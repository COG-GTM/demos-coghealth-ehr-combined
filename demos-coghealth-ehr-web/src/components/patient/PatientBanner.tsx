...
export default function PatientBanner({ patient, allergies = [] }: PatientBannerProps) {
  ...
  return (
    <div className="border-b" style={{ background: 'linear-gradient(to bottom, var(--ehr-patient-header-from) 0%, var(--ehr-patient-header-to) 100%)', borderColor: 'var(--ehr-border)' }}>
