      ...
      <div className={`relative ${widthClasses[width]} max-h-[90vh] flex flex-col`} style={{ fontFamily: 'Tahoma, sans-serif' }}>
        ...
        <div className="bg-white border-2 border-gray-400 shadow-lg flex flex-col" style={{ boxShadow: '2px 2px 8px rgba(0,0,0,0.3)' }}>
          ...
          <div 
            ...
            style={{ background: 'var(--ehr-titlebar-bg)' }}
          >
          ...
          {/* Content */}
          <div className="flex-1 overflow-auto p-3 bg-[var(--ehr-panel-alt)]">
            {children}
          </div>
          
          {/* Footer */}
          {footer && (
            <div className="px-3 py-2 bg-[var(--ehr-panel-alt)] border-t border-gray-400 flex justify-end space-x-2">
              {footer}
            </div>
          )}
        </div>
