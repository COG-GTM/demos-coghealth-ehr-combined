...
export function LoadingOverlay({ isLoading, text = 'Loading...' }: LoadingOverlayProps) {
  ...
  return (
    ...
    >
      <div className="ehr-loading-overlay flex flex-col items-center bg-[#ece9d8] border-2 border-gray-400 px-6 py-4 shadow-md" style={{ boxShadow: '2px 2px 4px rgba(0,0,0,0.3)' }}>
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
