...
export function LoadingOverlay({ isLoading, text = 'Loading...' }: LoadingOverlayProps) {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center px-6 py-4 shadow-md" style={{ background: 'var(--ehr-loading-bg)', border: '2px solid var(--ehr-border)', boxShadow: '2px 2px 4px rgba(0,0,0,0.3)' }}>
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
