...
export function LoadingOverlay({ isLoading, text = 'Loading...' }: LoadingOverlayProps) {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center border-2 px-6 py-4 shadow-md" style={{ background: 'var(--ehr-modal-bg)', borderColor: 'var(--ehr-border)', boxShadow: '2px 2px 4px rgba(0,0,0,0.3)' }}>
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
