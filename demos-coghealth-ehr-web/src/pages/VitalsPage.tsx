        ...
        <div className="flex-1 overflow-auto bg-white border border-gray-400">
          <table className="w-full text-[11px]">
            <thead className="sticky top-0">
              <tr className="bg-gradient-to-b from-[#f0f0f0] to-[#e0e0e0] dark:from-[#333a45] dark:to-[#2a3038]">
                <th className="text-left px-2 py-1 border border-gray-400 bg-gradient-to-b from-[#f8f8f8] to-[#e8e8e8] dark:from-[#333a45] dark:to-[#2a3038] sticky left-0 z-10 min-w-[100px]">Vital Sign</th>
                <th className="text-center px-2 py-1 border border-gray-400 bg-gradient-to-b from-[#f8f8f8] to-[#e8e8e8] dark:from-[#333a45] dark:to-[#2a3038] min-w-[50px]">Trend</th>
                {vitals.map((reading) => (
            ...
            <tbody>
              {vitalSigns.map((vital, vitalIdx) => (
                <tr key={vital.key} className={vitalIdx % 2 === 0 ? 'bg-white' : 'bg-[#f8f8f8] dark:bg-[#22272f]'}>
                  ...
                  {vitals.map((reading, readingIdx) => {
                    ...
                    return (
                      <td
                        key={reading.id}
                        className={`px-2 py-1 border border-gray-300 text-center cursor-pointer hover:bg-[#e0e8f0] dark:hover:bg-[#2a3a4d] ${getStatusClass(status)}`}
