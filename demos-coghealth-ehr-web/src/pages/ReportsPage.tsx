  ...
  return (
    <div className="ehr-page-shell h-full flex flex-col" style={{ background: '#d4d0c8' }}>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="ehr-page-sidebar w-56 overflow-auto p-2 space-y-2" style={{ background: '#ece9d8' }}>
            ...
            return (
              <div key={category} className="border-b border-gray-300">
                <div
                  ...
                  className="ehr-report-category-header px-2 py-1 bg-gray-100 hover:bg-gray-200 cursor-pointer flex items-center justify-between text-[11px] border-b border-gray-400"
