  ...
  return (
    <div className="h-full flex flex-col ehr-page-bg">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-56 overflow-auto p-2 space-y-2 ehr-surface-bg">
            ...
            return (
              <div key={category} className="border-b border-gray-300">
                <div
                  ...
                  className="px-2 py-1 cursor-pointer flex items-center justify-between text-[11px]"
                  style={{ background: 'linear-gradient(to bottom, var(--ehr-btn-from) 0%, var(--ehr-btn-to) 100%)', borderBottom: '1px solid var(--ehr-border)', color: 'var(--ehr-text)' }}
                >
                  <div className="flex items-center space-x-2">
