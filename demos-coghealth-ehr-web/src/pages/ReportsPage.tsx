  ...
  return (
    <div className="h-full flex flex-col" style={{ background: 'var(--ehr-desktop)' }}>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-56 overflow-auto p-2 space-y-2" style={{ background: 'var(--ehr-status-bar)' }}>
            ...
            return (
              <div key={category} className="border-b border-gray-300">
                <div
                  ...
                  style={{ background: 'linear-gradient(to bottom, var(--ehr-raised-top) 0%, var(--ehr-raised-bottom) 100%)' }}
                >
                  <div className="flex items-center space-x-2">
