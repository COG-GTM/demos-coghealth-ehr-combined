  ...
  return (
    <div className="h-full flex flex-col" style={{ background: 'var(--ehr-desktop)' }}>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-56 overflow-auto p-2 space-y-2" style={{ background: 'var(--ehr-panel-bg)' }}>
            ...
            return (
              <div key={category} className="border-b border-gray-300">
                <div
                  ...
                  className="ehr-subheader px-2 py-1 hover:bg-gray-200 cursor-pointer flex items-center justify-between text-[11px] font-normal"
                >
                  <div className="flex items-center space-x-2">
