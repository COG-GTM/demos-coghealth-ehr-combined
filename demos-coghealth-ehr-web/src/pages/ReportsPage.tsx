            ...
            return (
              <div key={category} className="border-b border-gray-300">
                <div
                  ...
                  className="px-2 py-1 cursor-pointer flex items-center justify-between text-[11px] border-b"
                  style={{ background: 'var(--ehr-bg-button)', borderColor: 'var(--ehr-border)', color: 'var(--ehr-text)' }}
                >
                  <div className="flex items-center space-x-2">
