  ...
  return (
    <div className="h-full flex flex-col ehr-desktop">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-56 overflow-auto p-2 space-y-2 ehr-chrome">
            ...
            return (
              <div key={category} className="border-b border-gray-300">
                <div
                  ...
                  className="px-2 py-1 ehr-bar ehr-bar-hover cursor-pointer flex items-center justify-between text-[11px] border-b border-gray-400"
                >
                  <div className="flex items-center space-x-2">
