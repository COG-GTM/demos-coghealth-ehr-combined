          ...
          {filteredPanels.length === 0 ? (
            ...
            filteredPanels.map(panel => (
              <div key={panel.id} className="border-b border-gray-300">
                <div
                  className="flex items-center justify-between px-2 py-1.5 [background:var(--ehr-control-bg)] cursor-pointer hover:[background:var(--ehr-control-bg-hover)]"
                  ...
                  <table className="w-full text-[11px]">
                    ...
                    <tbody>
                      {panel.results.map((result, idx) => (
                        <tr
                          key={result.id}
                          className={`cursor-pointer hover:bg-[var(--ehr-hover)] ${idx % 2 === 0 ? 'bg-white' : 'bg-[var(--ehr-row-alt)]'}`}
