  ...
  return (
    <div className="ehr-page-shell h-full flex flex-col" style={{ background: '#d4d0c8' }}>
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Left Filter Panel */}
        <div className="ehr-page-sidebar w-52 flex flex-col border-r border-gray-500" style={{ background: '#ece9d8' }}>
        ...
        {selectedPatient && (
          <div className="ehr-page-panel w-72 flex flex-col border-l border-gray-500" style={{ background: '#f5f5f5' }}>
            <div className="ehr-header text-xs flex items-center justify-between">
