  ...
  return (
    <div className="h-full flex flex-col ehr-app-bg">
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Left Filter Panel */}
        <div className="w-52 flex flex-col border-r border-gray-500 ehr-surface-alt">
        ...
        {selectedPatient && (
          <div className="w-72 flex flex-col border-l border-gray-500 ehr-surface">
            <div className="ehr-header text-xs flex items-center justify-between">
            ...
            <div className="flex-1 overflow-auto">
              {/* Patient Header */}
              <div className="p-2 border-b border-gray-400 ehr-surface-strip">
                <div className="flex items-center space-x-2">
