  ...
  return (
    <div className="h-full flex flex-col ehr-page-bg">
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Left Filter Panel */}
        <div className="w-52 flex flex-col border-r ehr-sidebar-bg" style={{ borderColor: 'var(--ehr-border)' }}>
        ...
        {selectedPatient && (
          <div className="w-72 flex flex-col border-l" style={{ background: 'var(--ehr-bg-panel)', borderColor: 'var(--ehr-border)' }}>
            <div className="ehr-header text-xs flex items-center justify-between">
            ...
            <div className="flex-1 overflow-auto">
              {/* Patient Header */}
              <div className="p-2 border-b" style={{ background: 'var(--ehr-bg-header-detail)', borderColor: 'var(--ehr-border)' }}>
                <div className="flex items-center space-x-2">
                  <div className="w-10 h-10 flex items-center justify-center border" style={{ background: 'var(--ehr-bg-avatar)', borderColor: 'var(--ehr-border)' }}>
