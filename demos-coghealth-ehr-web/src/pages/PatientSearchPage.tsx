                ...
                {searchResults.length === 0 && !loading ? (
                  ...
                  return (
                    <tr
                      ...
                      style={isSelected ? { background: '#316ac5', color: 'white' } : idx % 2 === 1 ? { background: 'var(--ehr-row-alt)' } : {}}
                    >
        ...
        {selectedPatient && (
          <div className="w-72 flex flex-col border-l border-gray-500" style={{ background: 'var(--ehr-panel-bg)' }}>
            ...
            <div className="flex-1 overflow-auto">
              {/* Patient Header */}
              <div className="p-2 border-b border-gray-400" style={{ background: 'var(--ehr-panel-header-bg)' }}>
                <div className="flex items-center space-x-2">
