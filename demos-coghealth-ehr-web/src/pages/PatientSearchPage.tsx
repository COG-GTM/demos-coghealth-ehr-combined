  ...
  return (
    <div className="h-full flex flex-col" style={{ background: 'var(--ehr-app-bg)' }}>
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Left Filter Panel */}
        <div className="w-52 flex flex-col border-r border-gray-500" style={{ background: 'var(--ehr-sidebar-bg)' }}>
        ...
        {selectedPatient && (
          <div className="w-72 flex flex-col border-l border-gray-500" style={{ background: 'var(--ehr-panel-bg)' }}>
            ...
            <div className="flex-1 overflow-auto">
              {/* Patient Header */}
              <div className="p-2 border-b border-gray-400" style={{ background: 'var(--ehr-subpanel-bg)' }}>
                <div className="flex items-center space-x-2">
