...
export default function PatientSearchPage() {
  ...
  return (
    <div className="h-full flex flex-col ehr-desktop-bg">
      {/* Toolbar */}
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {selectedPatient && (
          <div className="w-72 flex flex-col border-l border-gray-500 ehr-panel-bg">
            <div className="ehr-header text-xs flex items-center justify-between">
            ...
            <div className="flex-1 overflow-auto">
              {/* Patient Header */}
              <div className="p-2 border-b border-gray-400 ehr-sidebar-bg">
                <div className="flex items-center space-x-2">
