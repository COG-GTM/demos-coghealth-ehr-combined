  ...
  return (
    <div className="h-full flex flex-col" style={{ background: 'var(--ehr-desktop)' }}>
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Left Filter Panel */}
        <div className="w-52 flex flex-col border-r border-gray-500" style={{ background: 'var(--ehr-pane)' }}>
                ...
                {searchResults.length === 0 && !loading ? (
                  ...
                  return (
                    <tr
                      ...
                      style={isSelected ? { background: 'var(--ehr-selected-bg)', color: 'var(--ehr-selected-text)' } : idx % 2 === 1 ? { background: 'var(--ehr-row-alt)' } : {}}
                    >
