...
export default function PatientSearchPage() {
  ...
  return (
    <div className="h-full flex flex-col" style={{ background: 'var(--ehr-desktop-bg)' }}>
      {/* Toolbar */}
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Left Filter Panel */}
        <div className="w-52 flex flex-col border-r border-gray-500" style={{ background: 'var(--ehr-panel-2-bg)' }}>
                ...
                {searchResults.length === 0 && !loading ? (
                  ...
                  return (
                    <tr
                      ...
                      style={isSelected ? { background: '#316ac5', color: 'white' } : idx % 2 === 1 ? { background: 'var(--ehr-row-alt-bg)' } : {}}
                    >
        ...
        {selectedPatient && (
          <div className="w-72 flex flex-col border-l border-gray-500" style={{ background: 'var(--ehr-surface-bg)' }}>
            <div className="ehr-header text-xs flex items-center justify-between">
            ...
            <div className="flex-1 overflow-auto">
              {/* Patient Header */}
              <div className="p-2 border-b border-gray-400" style={{ background: 'var(--ehr-surface-2-bg)' }}>
                <div className="flex items-center space-x-2">
