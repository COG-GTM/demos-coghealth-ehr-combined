  ...
  return (
    <div className="h-full flex flex-col bg-[#d4d0c8] dark:bg-[#15181d]">
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Left Filter Panel */}
        <div className="w-52 flex flex-col border-r border-gray-500 bg-[#ece9d8] dark:bg-[#22272f] dark:bg-[#22272f]">
        ...
        {selectedPatient && (
          <div className="w-72 flex flex-col border-l border-gray-500 bg-[#f5f5f5] dark:bg-[#22272f]">
            <div className="ehr-header text-xs flex items-center justify-between">
            ...
            <div className="flex-1 overflow-auto">
              {/* Patient Header */}
              <div className="p-2 border-b border-gray-400 bg-[#e8e8e8] dark:bg-[#2c323b]">
                <div className="flex items-center space-x-2">
