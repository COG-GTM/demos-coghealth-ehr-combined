  ...
  return (
    <div className="h-full flex flex-col" style={{ background: 'var(--ehr-desktop)' }}>
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Left Filter Panel */}
        <div className="w-52 flex flex-col border-r border-gray-500" style={{ background: 'var(--ehr-status-bar)' }}>
                ...
                {searchResults.length === 0 && !loading ? (
                  ...
                  return (
                    <tr
                      ...
                      style={isSelected ? { background: 'var(--ehr-accent)', color: 'white' } : idx % 2 === 1 ? { background: 'var(--ehr-row-even)' } : {}}
                    >
        ...
        {selectedPatient && (
          <div className="w-72 flex flex-col border-l border-gray-500" style={{ background: 'var(--ehr-panel)' }}>
            ...
            <div className="flex-1 overflow-auto">
              {/* Patient Header */}
              <div className="p-2 border-b border-gray-400" style={{ background: 'var(--ehr-raised-bottom)' }}>
                <div className="flex items-center space-x-2">
