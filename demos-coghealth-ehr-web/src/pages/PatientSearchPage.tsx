  ...
  return (
    <div className="h-full flex flex-col ehr-page-bg">
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Left Filter Panel */}
        <div className="w-52 flex flex-col border-r border-gray-500 ehr-surface-bg">
        ...
        {selectedPatient && (
          <div className="w-72 flex flex-col border-l" style={{ background: 'var(--ehr-detail-bg)', borderColor: 'var(--ehr-border)' }}>
            <div className="ehr-header text-xs flex items-center justify-between">
            ...
            <div className="flex-1 overflow-auto">
              {/* Patient Header */}
              <div className="p-2" style={{ background: 'var(--ehr-detail-header-bg)', borderBottom: '1px solid var(--ehr-border)' }}>
                <div className="flex items-center space-x-2">
                  <div className="w-10 h-10 flex items-center justify-center border" style={{ background: 'var(--ehr-header-from)', borderColor: 'var(--ehr-border)' }}>
