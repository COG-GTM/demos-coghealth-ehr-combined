  ...
  return (
    <div className="h-full flex flex-col" style={{ background: 'var(--ehr-bg)' }}>
      ...
      <div className="flex-1 flex overflow-hidden">
                ...
                {filteredOrders.map((order, idx) => {
                  ...
                  return (
                    <tr
                      ...
                      style={isSelected ? { background: 'var(--ehr-grid-selected)', color: 'white' } : undefined}
                    >
        ...
        {/* Detail Panel */}
        <div className="w-80 flex flex-col overflow-hidden" style={{ background: 'var(--ehr-surface-raised)' }}>
          {selectedOrder ? (
            <>
              {/* Medication Header */}
...
function OrderRow({ order, selected, onSelect, idx }: { order: MedicationOrderExtended; selected: boolean; onSelect: () => void; idx: number }) {
  ...
  return (
    <div
      ...
      style={selected ? { background: 'var(--ehr-grid-selected)', color: 'white' } : undefined}
    >
      <div className="flex items-center space-x-2">
        <div className="w-6">
