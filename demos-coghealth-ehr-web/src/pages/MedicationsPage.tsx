  ...
  return (
    <div className="h-full flex flex-col" style={{ background: 'var(--ehr-chrome)' }}>
      ...
      <div className="flex-1 flex overflow-hidden">
                ...
                {filteredOrders.map((order, idx) => {
                  ...
                  return (
                    <tr
                      ...
                      style={isSelected ? { background: 'var(--ehr-selection)', color: 'white' } : undefined}
                    >
        ...
        {/* Detail Panel */}
        <div className="w-80 flex flex-col overflow-hidden" style={{ background: 'var(--ehr-panel-alt)' }}>
          {selectedOrder ? (
            <>
              {/* Medication Header */}
...
function OrderRow({ order, selected, onSelect, idx }: { order: MedicationOrderExtended; selected: boolean; onSelect: () => void; idx: number }) {
  ...
  return (
    <div
      ...
      style={selected ? { background: 'var(--ehr-selection)', color: 'white' } : undefined}
    >
      <div className="flex items-center space-x-2">
        <div className="w-6">
