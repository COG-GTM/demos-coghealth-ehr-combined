...
function App() {
  ...
  return (
    <BrowserRouter>
      <div className="ehr-desktop-bg h-screen flex flex-col" style={{ fontFamily: 'Tahoma, sans-serif' }}>
        <Navigation 
        ...
        <div className="ehr-statusbar h-5 border-t flex items-center justify-between px-2 text-[10px]">
