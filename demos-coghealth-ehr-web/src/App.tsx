...
function App() {
  ...
  return (
    <BrowserRouter>
      <div className="h-screen flex flex-col ehr-desktop-bg" style={{ fontFamily: 'Tahoma, sans-serif' }}>
        <Navigation 
        ...
        <div className="h-5 ehr-statusbar-bg border-t border-gray-400 flex items-center justify-between px-2 text-[10px] text-gray-600">
